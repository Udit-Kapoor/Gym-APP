...
TrainerAttendanceModel trainerAttendanceModelFromJson(String str) =>
    TrainerAttendanceModel.fromJson(json.decode(str));

String trainerAttendanceModelToJson(TrainerAttendanceModel data) =>
...
class TrainerAttendanceModel {
  ...
  factory TrainerAttendanceModel.fromJson(Map<String, dynamic> json) =>
      TrainerAttendanceModel(
