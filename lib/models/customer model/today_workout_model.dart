...
TodayWorkoutModel todayWorkoutModelFromJson(String str) => TodayWorkoutModel.fromJson(json.decode(str));

String todayWorkoutModelToJson(TodayWorkoutModel data) => json.encode(data.toJson());
...
Future<ApiResponse> todayWorkout() async {
  ApiResponse cp = await ApiHelper()
      .getReq(endpoint: "https://p2c-gym.herokuapp.com/customer/mytodayworkout/");
  return cp;
}
