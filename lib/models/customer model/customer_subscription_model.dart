...
class CustomerSubscriptionModel {
    ...
    factory CustomerSubscriptionModel.fromJson(Map<String, dynamic> json) => CustomerSubscriptionModel(
        ...
        specialFacility: List<ExercisePlan>.from(json["special_facility"].map((x) => ExercisePlan.fromJson(x))),
        specialActivity: List<ExercisePlan>.from(json["special_activity"].map((x) => ExercisePlan.fromJson(x))),
