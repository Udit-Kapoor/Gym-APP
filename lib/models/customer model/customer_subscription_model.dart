...
class CustomerSubscriptionModel {
  ...
  factory CustomerSubscriptionModel.fromJson(Map<String, dynamic> json) =>
      CustomerSubscriptionModel(
        ...
        specialFacility: List<SpecialIty>.from(
            json["special_facility"].map((x) => SpecialIty.fromJson(x))),
        specialActivity: List<SpecialIty>.from(
            json["special_activity"].map((x) => SpecialIty.fromJson(x))),
        locker: json["locker"],
